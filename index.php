...
<div class="row">
<div class="col-lg-6">
<span class="logo">QUIZOPHILE</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" name="sub" class="sub" value="sign up" class="btn btn-primary"/>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="https://www.facebook.com/mgmits.official" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">MITS</a>
...
0484-2732100</h4>
		...
		<h4 style="font-family:'typo' ">MUTHOOT INSTITUTE OF TECHNOLOGY AND SCIENCE, VARIKOLI</h4></div></div>
		</p>
      </div>
